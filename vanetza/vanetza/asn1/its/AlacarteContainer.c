...
asn_TYPE_member_t asn_MBR_AlacarteContainer_1[] = {
	{ATF_POINTER, 6, offsetof(struct AlacarteContainer, lanePosition), (ASN_TAG_CLASS_CONTEXT | (0 << 2)), -1, /* IMPLICIT tag at current level */
	 ...
	 0, /* No default value */
	 "lanePosition"},
	{ATF_POINTER, 5, offsetof(struct AlacarteContainer, impactReduction), (ASN_TAG_CLASS_CONTEXT | (1 << 2)), -1, /* IMPLICIT tag at current level */
	 ...
	 0, /* No default value */
	 "impactReduction"},
	{ATF_POINTER, 4, offsetof(struct AlacarteContainer, externalTemperature), (ASN_TAG_CLASS_CONTEXT | (2 << 2)), -1, /* IMPLICIT tag at current level */
	 &asn_DEF_Temperature,
	 0,
	 {
#if !defined(ASN_DISABLE_OER_SUPPORT)
	 ...
	 0, /* No default value */
	 "externalTemperature"},
	{ATF_POINTER, 3, offsetof(struct AlacarteContainer, roadWorks), (ASN_TAG_CLASS_CONTEXT | (3 << 2)), -1, /* IMPLICIT tag at current level */
	 ...
	 0, /* No default value */
	 "roadWorks"},
	{ATF_POINTER, 2, offsetof(struct AlacarteContainer, positioningSolution), (ASN_TAG_CLASS_CONTEXT | (4 << 2)), -1, /* IMPLICIT tag at current level */
	 ...
	 0, /* No default value */
	 "positioningSolution"},
	{ATF_POINTER, 1, offsetof(struct AlacarteContainer, stationaryVehicle), (ASN_TAG_CLASS_CONTEXT | (5 << 2)), -1, /* IMPLICIT tag at current level */
